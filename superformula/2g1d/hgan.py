...
class HGAN(object):
    ...
    def discriminator(self):
        ...
        q_mean1 = Dense(self.latent_dim, name="Q_mean1")(q1)
        ...
        q_mean2 = Dense(self.latent_dim, name="Q_mean2")(q2)
...
#                y_fake = label_flipping(y_fake, .1)
                ...
                if save_interval>0 and (t+1)%save_interval==0:
                    ...
                    with open('../hgan_idetc2018_data/superformula/2g1d/losses.pkl', 'wb') as f:
                    ...
                    plot_grid(9, gen_func=self.synthesize_parent, d=self.latent_dim,
                              scale=.85, save_path='superformula/2g1d/parent.svg')
                    plot_grid(9, gen_func=self.synthesize_child, d=self.latent_dim,
                              scale=.85, save_path='superformula/2g1d/child.svg')
