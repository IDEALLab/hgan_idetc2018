...
#        optimizer = RMSprop(lr=1e-3)
    ...
    def train(self, train_steps=2000, batch_size=256, save_interval=0, mode='startover'):
        ...
        g1_fname = '../hgan_idetc2018_data/airfoil/naive/generator1.h5'
        g2_fname = '../hgan_idetc2018_data/airfoil/naive/generator2.h5'
        d1_fname = '../hgan_idetc2018_data/airfoil/naive/discriminator1.h5'
        d_fname = '../hgan_idetc2018_data/airfoil/naive/discriminator.h5'
...
#                y_fake = label_flipping(y_fake, .1)
                ...
                if save_interval>0 and (t+1)%save_interval==0:
                    ...
                    plot_grid(9, gen_func=self.synthesize_parent, d=self.latent_dim, 
                              scale=.95, save_path='airfoil/naive/parent.svg')
                    plot_grid(9, gen_func=self.synthesize_child, d=self.latent_dim,
                              scale=.95, save_path='airfoil/naive/child.svg')
